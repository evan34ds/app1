        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        <?php
                        echo form_open_multipart('slider/add_galeri/');
                        ?>
                        <div class="form-grup">
                            <label>Judul</label>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            <?php
                            echo form_open_multipart('slider/edit_galeri/' . $value['id']) ?>
                            <div class="form-grup">
                                <label>Judul</label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="<?= ('/slider/delete_galeri/' . $value['id']) ?>" class="btn btn-info"> Delete</a>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
