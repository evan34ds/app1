  ...
  <section id="about" class="about">
    <div class="container">
      ...
      <div class="row content">
        <div class="col-lg-6">
          <h3  align="center"><img src="<?= base_url('fotodosen/' . $data_institusi['foto_dosen']) ?>" class="img-circle" width="500px" height="500px"></h3>
          <h3 align="center"><?= $data_institusi['nama_dosen'] ?></h3>
        </div>
