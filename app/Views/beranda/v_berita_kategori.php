    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 entries">
          ...
          foreach ($listBeritaKategori as $data) :
          ?>
            <article class="entry">

              <div class="entry-img">
                <img src="<?= base_url('/img/berita/thumb/' . $data['gambar']) ?>" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="<?= base_url('home/uraian_berita/' . $data['slug_berita']) ?>"><?= $data['judul_berita'] ?>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single.html"><?= $data['nama_user'] ?></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single.html"><time datetime="2020-01-01"><?= date_indo($data['tgl_berita']) ?></time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog-single.html"><?= $data['nama_kategori'] ?></a></li>
                </ul>
              </div>

              <div class="entry-content">
                <p>
                  <?= substr(strip_tags($data['isi']), 0, 500) ?>...
                </p>
                <div class="read-more">
                  <a href="<?= base_url('home/uraian_berita/' . $data['slug_berita']) ?>">Read More</a>
                </div>
              </div>
