...
class Slider extends BaseController
{
...

    {
        $data = [
            'title' =>    'Galeri',
            'galeri'  => $this->ModelAdmin->daftar_galeri(),
            'isi'    =>    'admin/galeri/v_index_galeri'
    ...
    public function add_galeri()
    {
        if ($this->validate([
            ...
            $this->ModelAdmin->add_slider($data);
            session()->setFlashdata('pesan', 'Data Berhasil Di Tambahkan !!!');
            return redirect()->to('/slider/galeri');
        } else {
            //jika tidak valid
            session()->setFlashdata('errors', \Config\Services::validation()->getErrors());
            return redirect()->to(base_url('slider/galeri'));
        }
    }
